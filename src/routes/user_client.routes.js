...
router.delete('/:id_user/:id_client', checkRole(['ADMIN']), userClientController.removeAssignment);
...
router.get('/client/:id_client/users', checkRole(['ADMIN', 'SUPERVISOR']), userClientController.getUsersByClient);
